...
$allowedKeys = ['ticker_price_ttl', 'default_vault_tab', 'auth_check_interval', 'self_registration', 'require_email_verification', 'invite_expiry_days', 'lockout_tier3_duration'];
